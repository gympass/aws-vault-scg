...
version_number=$(get_latest_release | sed -e '1s/^.//')
file_name="${exe_name}_${version_number}_${os}_${arch}.tar.gz" # the file name should be download
